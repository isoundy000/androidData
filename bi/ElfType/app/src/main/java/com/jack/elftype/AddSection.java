...
public class AddSection {
	...
	public static byte[] addSectionHeader(byte[] src){
		...
		newHeader = Utils.replaceByteAry(newHeader, 8, Utils.int2Byte(ElfType32.SHF_ALLOC));		//改字节区可以被写入
		newHeader = Utils.replaceByteAry(newHeader, 12, Utils.int2Byte(0x5010));			//所代表的字节区其实地址
