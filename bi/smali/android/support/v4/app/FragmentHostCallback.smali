...
.field private mAllLoaderManagers:Lcom/bilibili/mi;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/bilibili/mi",
            "<",
...
.field private mLoaderManager:Lcom/bilibili/dx;
...
.method doLoaderDestroy()V
    ...
    .prologue
    .line 255
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->mLoaderManager:Lcom/bilibili/dx;
    ...
    invoke-virtual {v0}, Lcom/bilibili/dx;->g()V
...
.method doLoaderRetain()V
    ...
    invoke-virtual {v0}, Lcom/bilibili/dx;->c()V
...
.method doLoaderStart()V
    ...
    invoke-virtual {v0}, Lcom/bilibili/dx;->a()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentHostCallback;->getLoaderManager(Ljava/lang/String;ZZ)Lcom/bilibili/dx;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->mLoaderManager:Lcom/bilibili/dx;
    ...
    iget-boolean v0, v0, Lcom/bilibili/dx;->b:Z
...
.method doLoaderStop(Z)V
    ...
    invoke-virtual {v0}, Lcom/bilibili/dx;->b()V
...
.method dumpLoaders(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Lcom/bilibili/dx;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method getLoaderManager(Ljava/lang/String;ZZ)Lcom/bilibili/dx;
    .locals 2

    .prologue
    .line 277
    iget-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->mAllLoaderManagers:Lcom/bilibili/mi;
    ...
    invoke-direct {v0}, Lcom/bilibili/mi;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/FragmentHostCallback;->mAllLoaderManagers:Lcom/bilibili/mi;
    ...
    check-cast v0, Lcom/bilibili/dx;
    ...
    .line 283
    new-instance v0, Lcom/bilibili/dx;

    invoke-direct {v0, p1, p0, p2}, Lcom/bilibili/dx;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V

    .line 284
    iget-object v1, p0, Landroid/support/v4/app/FragmentHostCallback;->mAllLoaderManagers:Lcom/bilibili/mi;
    ...
    .line 287
    :cond_2
    invoke-virtual {v0, p0}, Lcom/bilibili/dx;->a(Landroid/support/v4/app/FragmentHostCallback;)V

    goto :goto_0
.end method

.method getLoaderManagerImpl()Lcom/bilibili/dx;
    .locals 3
...
.method inactivateFragment(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Lcom/bilibili/dx;->c:Z
...
.method reportLoaderStart()V
    ...
    invoke-virtual {v0}, Lcom/bilibili/mi;->size()I

    move-result v2

    .line 264
    new-array v3, v2, [Lcom/bilibili/dx;
    ...
    invoke-virtual {v0, v1}, Lcom/bilibili/mi;->b(I)Ljava/lang/Object;
    ...
    .line 270
    invoke-virtual {v1}, Lcom/bilibili/dx;->d()V

    .line 271
    invoke-virtual {v1}, Lcom/bilibili/dx;->f()V
...
.method restoreLoaderNonConfig(Lcom/bilibili/mi;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 320
    iput-object p1, p0, Landroid/support/v4/app/FragmentHostCallback;->mAllLoaderManagers:Lcom/bilibili/mi;

    .line 321
    return-void
.end method

.method retainLoaderNonConfig()Lcom/bilibili/mi;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 298
    new-array v4, v3, [Lcom/bilibili/dx;
    ...
    invoke-virtual {v0, v2}, Lcom/bilibili/mi;->b(I)Ljava/lang/Object;
    ...
    .line 304
    iget-boolean v5, v2, Lcom/bilibili/dx;->c:Z
    ...
    .line 307
    :cond_1
    invoke-virtual {v2}, Lcom/bilibili/dx;->g()V

    .line 308
    iget-object v5, p0, Landroid/support/v4/app/FragmentHostCallback;->mAllLoaderManagers:Lcom/bilibili/mi;

    iget-object v2, v2, Lcom/bilibili/dx;->b:Ljava/lang/String;

    invoke-virtual {v5, v2}, Lcom/bilibili/mi;->remove(Ljava/lang/Object;)Ljava/lang/Object;
