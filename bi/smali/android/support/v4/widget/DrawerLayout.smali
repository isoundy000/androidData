...
.field private final a:Landroid/support/v4/widget/DrawerLayout$i;

.field private final a:Lcom/bilibili/tu;
...
.field private final b:Landroid/support/v4/widget/DrawerLayout$i;

.field private final b:Lcom/bilibili/tu;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$b;
    ...
    .line 191
    iput-boolean v4, p0, Landroid/support/v4/widget/DrawerLayout;->f:Z
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$i;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$i;

    .line 360
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$i;

    invoke-static {p0, v5, v2}, Lcom/bilibili/tu;->a(Landroid/view/ViewGroup;FLcom/bilibili/tu$a;)Lcom/bilibili/tu;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    .line 361
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    invoke-virtual {v2, v4}, Lcom/bilibili/tu;->a(I)V

    .line 362
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    invoke-virtual {v2, v1}, Lcom/bilibili/tu;->a(F)V

    .line 363
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$i;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$i;->a(Lcom/bilibili/tu;)V

    .line 365
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$i;

    invoke-static {p0, v5, v2}, Lcom/bilibili/tu;->a(Landroid/view/ViewGroup;FLcom/bilibili/tu$a;)Lcom/bilibili/tu;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    .line 366
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Lcom/bilibili/tu;->a(I)V
    ...
    .line 368
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$i;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$i;->a(Lcom/bilibili/tu;)V
    ...
    invoke-static {p0, v1}, Lcom/bilibili/oh;->a(Landroid/view/View;Lcom/bilibili/ml;)V

    .line 377
    const/4 v1, 0x0

    invoke-static {p0, v1}, Lcom/bilibili/oy;->a(Landroid/view/ViewGroup;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Ljava/util/ArrayList;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lcom/bilibili/oh;->b(Landroid/view/View;I)V
...
.method private a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p1}, Lcom/bilibili/gq;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1024
    :cond_1
    invoke-static {p1, p2}, Lcom/bilibili/gq;->b(Landroid/graphics/drawable/Drawable;I)V
...
.method private b()Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->d(Landroid/view/View;)Z
...
.method private b()Z
    ...
    .line 1579
    iget-boolean v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:Z
...
.method private c()V
    ...
    .line 974
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->c()Landroid/graphics/drawable/Drawable;
...
.method static synthetic e(Landroid/view/View;)Z
    ...
    .prologue
    .line 90
    invoke-static {p0}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
...
.method a(Landroid/view/View;)F
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
...
.method public a(I)I
    ...
    invoke-static {p1, v0}, Lcom/bilibili/mu;->a(II)I
...
.method a()Landroid/view/View;
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->b:Z
...
.method public a(I)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/DrawerLayout;->a(I)Ljava/lang/String;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Lcom/bilibili/tu;->a()I

    move-result v2

    .line 684
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    invoke-virtual {v3}, Lcom/bilibili/tu;->a()I
    ...
    .line 697
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/DrawerLayout$f;->b(I)V
...
.method public a(ILandroid/view/View;)V
    ...
    .prologue
    .line 593
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/view/View;)Z
...
.method a(Landroid/view/View;)V
    ...
    .line 715
    iget-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$g;->b:Z

    if-eqz v1, :cond_1

    .line 716
    iput-boolean v2, v0, Landroid/support/v4/widget/DrawerLayout$g;->b:Z
...
.method public a(Ljava/lang/Object;Z)V
    ...
    .line 425
    iput-boolean p2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Z
...
.method a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:Z
    ...
    .line 1410
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;
    ...
    invoke-virtual {v7, v5, v6, v8}, Lcom/bilibili/tu;->a(Landroid/view/View;II)Z
    ...
    .line 1417
    :goto_2
    iput-boolean v3, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:Z

    goto :goto_1

    .line 1413
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;
    ...
    invoke-virtual {v6, v5, v7, v8}, Lcom/bilibili/tu;->a(Landroid/view/View;II)Z
    ...
    .line 1420
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$i;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout$i;->a()V

    .line 1421
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$i;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1748
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/DrawerLayout$b;
...
.method b(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Lcom/bilibili/mu;->a(II)I
...
.method b()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Z
...
.method b(Landroid/view/View;F)V
    ...
    .line 779
    iget v1, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
    ...
    .line 783
    :cond_0
    iput p2, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
...
.method public c(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
    ...
    .line 1446
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/bilibili/tu;->a(Landroid/view/View;II)Z

    goto :goto_0

    .line 1448
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;
...
.method c(Landroid/view/View;F)V
    ...
    .prologue
    .line 817
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->a(Landroid/view/View;)F
...
.method public computeScroll()V
    ...
    .line 1127
    :cond_0
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:F

    .line 1130
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    invoke-virtual {v0, v4}, Lcom/bilibili/tu;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    invoke-virtual {v1, v4}, Lcom/bilibili/tu;->a(Z)Z
...
.method public d(Landroid/view/View;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/DrawerLayout$g;->b:Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1232
    iget v2, p0, Landroid/support/v4/widget/DrawerLayout;->c:F
    ...
    iget v3, p0, Landroid/support/v4/widget/DrawerLayout;->c:F
    ...
    invoke-virtual {v2}, Lcom/bilibili/tu;->b()I
    ...
    invoke-virtual {v3}, Lcom/bilibili/tu;->b()I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lcom/bilibili/tu;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->b:Lcom/bilibili/tu;

    invoke-virtual {v4, p1}, Lcom/bilibili/tu;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->b()Z
    ...
    .line 1292
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->e:F

    .line 1293
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->c:F
    ...
    .line 1294
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Lcom/bilibili/tu;->a(II)Landroid/view/View;
    ...
    .line 1300
    iput-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Z
    ...
    invoke-virtual {v0, v4}, Lcom/bilibili/tu;->b(I)Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->c()Z
    ...
    .line 1678
    invoke-static {p2}, Lcom/bilibili/mx;->a(Landroid/view/KeyEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:F
...
.method protected onMeasure(II)V
    ...
    .line 926
    iget v9, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:I

    invoke-static {v9, v6}, Lcom/bilibili/mu;->a(II)I

    move-result v9

    .line 927
    invoke-static {v8}, Lcom/bilibili/oh;->d(Landroid/view/View;)Z
    ...
    .line 936
    iget v9, v0, Landroid/support/v4/widget/DrawerLayout$g;->leftMargin:I

    sub-int v9, v2, v9

    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$g;->rightMargin:I
    ...
    .line 938
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$g;->topMargin:I
    ...
    .line 943
    invoke-static {v8}, Lcom/bilibili/oh;->m(Landroid/view/View;)F

    move-result v9

    iget v10, p0, Landroid/support/v4/widget/DrawerLayout;->b:F
    ...
    invoke-static {v8, v9}, Lcom/bilibili/oh;->m(Landroid/view/View;F)V

    .line 947
    :cond_c
    invoke-virtual {p0, v8}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/view/View;)I
    ...
    invoke-static {v9}, Landroid/support/v4/widget/DrawerLayout;->a(I)Ljava/lang/String;
    ...
    .line 954
    :cond_d
    iget v9, p0, Landroid/support/v4/widget/DrawerLayout;->l:I

    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$g;->leftMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/DrawerLayout$g;->width:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/bilibili/tu;->a(Landroid/view/MotionEvent;)V
    ...
    .line 1347
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->a:Lcom/bilibili/tu;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lcom/bilibili/tu;->a(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Lcom/bilibili/tu;->d()I
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 1383
    iput-boolean p1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Z
...
.method public setDrawerElevation(F)V
    ...
    .line 398
    invoke-virtual {p0, v1}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/view/View;)Z
...
.method public setDrawerLockMode(II)V
    ...
    invoke-static {p2, v0}, Lcom/bilibili/mu;->a(II)I
    ...
    .line 555
    :goto_1
    invoke-virtual {v0}, Lcom/bilibili/tu;->a()V
