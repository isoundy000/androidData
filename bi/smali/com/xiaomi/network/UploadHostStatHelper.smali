...
# static fields
.field private static a:Lcom/xiaomi/network/UploadHostStatHelper;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Ljava/util/Random;

    new-instance v0, Ljava/util/Timer;

    const-string/jumbo v1, "Upload Http Record Timer"

    invoke-direct {v0, v1}, Ljava/util/Timer;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Ljava/util/Timer;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Landroid/content/Context;
...
.method public static declared-synchronized a()Lcom/xiaomi/network/UploadHostStatHelper;
    ...
    :try_start_0
    sget-object v1, Lcom/xiaomi/network/UploadHostStatHelper;->a:Lcom/xiaomi/network/UploadHostStatHelper;
    :try_end_0
...
.method private a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/network/UploadHostStatHelper;->a(Ljava/lang/String;)[B
...
.method public static synthetic a(Lcom/xiaomi/network/UploadHostStatHelper;)Ljava/util/List;
    .locals 1
...
.method public static declared-synchronized a(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Lcom/xiaomi/network/UploadHostStatHelper;
    ...
    sput-object v0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Lcom/xiaomi/network/UploadHostStatHelper;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic a(Lcom/xiaomi/network/UploadHostStatHelper;Ljava/util/List;D)V
    .locals 0
...
.method private a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "56C6A520%$C99119A0&^229(!@2746C7"
    ...
    const-string/jumbo v0, "http://%1$s/diagnoses/v1/report"
    ...
    iget-object v1, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Landroid/content/Context;
...
.method private a(Ljava/util/List;D)V
    ...
    new-instance v3, Lcom/bilibili/btc;

    new-instance v4, Lorg/apache/thrift/protocol/b$a;

    invoke-direct {v4}, Lorg/apache/thrift/protocol/b$a;-><init>()V

    invoke-direct {v3, v4}, Lcom/bilibili/btc;-><init>(Lorg/apache/thrift/protocol/h;)V

    invoke-virtual {v3, v2}, Lcom/bilibili/btc;->a(Lorg/apache/thrift/b;)[B
    ...
    iget-object v2, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Ljava/util/Random;
    ...
    :try_start_0
    const-string/jumbo v2, "f3.mi-stat.gslb.mi-idc.com"
...
.method public static synthetic a(Lcom/xiaomi/network/UploadHostStatHelper;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Z
...
.method public b()V
    ...
    iget-boolean v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Z
    ...
    iget-object v0, p0, Lcom/xiaomi/network/UploadHostStatHelper;->a:Ljava/util/Timer;

    new-instance v1, Lcom/bilibili/bnm;

    invoke-direct {v1, p0}, Lcom/bilibili/bnm;-><init>(Lcom/xiaomi/network/UploadHostStatHelper;)V
